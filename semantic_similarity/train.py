...
def train():
    ...
    train_dataset = data_setup.BertDatasetTraining(input1=train['sentence_1'],
                                                   input2=train['sentence_2'],
                                                   target=train['similarity'])

    dev_dataset = data_setup.BertDatasetTraining(input1=dev['sentence_1'],
                                                   input2=dev['sentence_2'],
                                                   target=dev['similarity'])
