...
def train():
    ...
    train_sent, val_sent, train_tag, val_tag = model_selection.train_test_split(sentences, tags,test_size=.2,random_state=42)
    ...
    val_dataloader = torch.utils.data.DataLoader(val_dataset, batch_size=1, num_workers=4)
